...
function addItemToDOM(item) {
  ...
  const editButton = createButton('edit-item btn-link text-blue', 'fa fa-edit');
  buttonsDiv.appendChild(editButton);

  const deleteButton = createButton('remove-item btn-link text-red', 'fa fa-trash');
...
function createButton(buttonClasses, iconClasses) {
